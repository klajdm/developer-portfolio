...
export default function Navbar() {
  return (
    <nav className="fixed left-0 top-0 w-full z-[999]">
      <div className=" flex justify-between items-center px-5 lg:px-10 bg-white/80 shadow backdrop-blur-[3px]">
        ...
        <div className="flex items-center h-16 space-x-5">
          <ul className="hidden lg:flex space-x-5 text-lg">
            <Link href="/">
              <li>Home</li>
            </Link>
            <Link href="./#about">
          ...
          <div className="lg:hidden cursor-pointer">
            <Menu as="div" className="relative">
              ...
              >
                <Menu.Items className="absolute right-0 z-10 mt-10 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none max-h-64 overflow-y-auto ">
                  <div className="p-1">
                    {links.map((link) => (
