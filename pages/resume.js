  ...
  return (
    <>
      <div className="min-h-screen relative flex flex-col items-center md:justify-center ">
        <h1 className="relative custom-h1 text-center w-fit   my-10">
          Curriculum Vitae
        </h1>
        <div className=" w-[95%] h-[564px] md:w-[85%] md:h-[1064px] lg:w-[720px] relative mb-20">
          <div className="absolute bg-[#86906F] hover:bg-[#90a06a] text-white w-12 h-12 rounded-full shadow-lg z-10 flex justify-center items-center right-[-1rem] top-[-1.3rem] hover:scale-105 cursor-pointer text-xl">
